...
#define BUTON_1_Pin GPIO_PIN_2
#define BUTON_1_GPIO_Port GPIOB
#define BUTON_2_Pin GPIO_PIN_10
#define BUTON_2_GPIO_Port GPIOB
#define BUTON_3_Pin GPIO_PIN_11
#define BUTON_3_GPIO_Port GPIOB
