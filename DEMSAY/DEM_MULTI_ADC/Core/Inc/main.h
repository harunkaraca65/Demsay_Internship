...
/* Private defines -----------------------------------------------------------*/
#define A1_IN0_TRIMPOT1_Pin GPIO_PIN_0
#define A1_IN0_TRIMPOT1_GPIO_Port GPIOA
#define A1_IN0_TRIMPOT2_Pin GPIO_PIN_1
#define A1_IN0_TRIMPOT2_GPIO_Port GPIOA
#define A1_IN4_NTC_Pin GPIO_PIN_4
#define A1_IN4_NTC_GPIO_Port GPIOA
#define A1_IN4_LDR_Pin GPIO_PIN_5
#define A1_IN4_LDR_GPIO_Port GPIOA
